...
public class Bot extends TelegramLongPollingBot {
    ...
    private final String RULES = "Правила игры: \n" +
    ...
    private void sendMsg(Message message, String text) {
        ...
        if (message.getText().startsWith("/help") || message.getText().startsWith("/start")) {
            ...
            String temp = "";
            File file = new File("src/main/flags" + File.separator + message.getText().toLowerCase() + ".png");
            if (file.exists()) {
                ...
                if (sqlHandler.isCountryAlreadyFound(message.getChat().getUserName(), message.getText().toUpperCase())) {
                    sendPhoto.setNewPhoto(new File("src/main/flags" + File.separator + "repeat.jpg"));
                    ...
                    sendMessage.setText(answers.getRandomCorrectAnswer() + "\nЭто флаг страны : " + temp + "" +
                ...
                sendPhoto.setNewPhoto(new File("src/main/flags" + File.separator + "pirate.jpg"));
                sendMessage.setText(answers.getRandomWrongAnswer() + "\nТы теряешь одну монету." +
                        "\nТвой текущий счёт :" + sqlHandler.currentScore(message.getChat().getUserName()));
